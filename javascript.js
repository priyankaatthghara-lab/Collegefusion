...
container.innerHTML=cards.map(card=>`
   ...
   <a href="${card.destination}" class="btn">${card.view}</a>
    ...
    ${carddetail.button}
        ...
        `).join("");
const clubcarddetails=[{heading:"Web Development",description:"Crafting dynamic, responsive, and user‑friendly web experiences.",members:"members:150",Totalevent:"Total events:40",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Cybersecurity",description:"Cybersecurity: where vigilance meets innovation.",members:"members:100",Totalevent:"Total events:30",button:"Join",backgroundimage:"cybersecurity.png"},{heading:"IOS Development",description:"Crafting dynamic, responsive, and user‑friendly web experiences.",members:"members:100",Totalevent:"Total events:40",button:"Join",backgroundimage:"iosdevelopment.png"},{heading:"Data Science",description:"Unlocking insights, turning data into decisions.",members:"members:150",Totalevent:"Total events:60",button:"Join",backgroundimage:"datascience.png"},{heading:"Android Development",description:"Creating smart, seamless apps for every screen.",members:"members:190",Totalevent:"Total events:30",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Artificial Intelligence",description:"Transforming machines into minds that learn and adapt.",members:"members:200",Totalevent:"Total events:70",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Gentech",description:"Driving innovation through science, technology, and creativity.",members:"members:200",Totalevent:"Total events:30",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Cloud Computing",description:"Scaling ideas seamlessly across the cloud.",members:"members:120",Totalevent:"Total events:44",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Software Development",description:"Designing, building, and refining solutions through code.",members:"members:200",Totalevent:"Total events:40",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Astronomy",description:"Exploring the cosmos, unlocking the mysteries of the universe.",members:"members:150",Totalevent:"Total events:40",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Hyper Lab GTC Members",description:"HyperLab GTC: Innovating together, empowering future leaders.",members:"members:300",Totalevent:"Total events:40",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Media Tech",description:"Blending creativity and technology to shape modern media.",members:"members:225",Totalevent:"Total events:80",button:"Join",backgroundimage:"webdevelopment.png"},{heading:"Bio Syner Gen",description:"Advancing life sciences through synergy and innovation.",members:"members:275",Totalevent:"Total events:40",button:"Join",backgroundimage:"webdevelopment.png"}]
...
<p>Registration Ends: ${hackathon.registrationend}</p></div>
      <button class="button">${hackathon.button}</button>
     
        </div>
        `).join("");

const companies=[{img:"HCl.png",name:"HCL",scheduledate:"Schedule Date:12 June", Seat:"Available seat:10",button:"Book"},{img:"Accenture.png",name:"Accenture",scheduledate:"Schedule Date:28 June", Seat:"Available seat:30",button:"Book"},{img:"amazon.png",name:"Amazon",scheduledate:"Schedule Date:17 July", Seat:"Available seat:3",button:"Book"},{img:"wipro.png",name:"Wipro",scheduledate:"Schedule Date:8 August", Seat:"Available seat:19",button:"Book"},{img:"infosys.png",name:"Infosys",scheduledate:"Schedule Date:27 June", Seat:"Available seat:18",button:"Book"},{img:"google.png",name:"Google",scheduledate:"Schedule Date:2 September", Seat:"Available seat:1",button:"Book"},{img:"nvidia.png",name:"Nvidia",scheduledate:"Schedule Date:15 August", Seat:"Available seat:4",button:"Book"},{img:"tcs.png",name:"TCS",scheduledate:"Schedule Date:27 August", Seat:"Available seat:40",button:"Book"},{img:"microsoft.png",name:"Micosoft",scheduledate:"Schedule Date:5 July", Seat:"Available seat:3",button:"Book"}];
...
companyvisit.innerHTML= companies.map(company=>`
    ...
    <p>${company.Seat}</p>
    <button class="button">${company.button}</button>
    </div>
